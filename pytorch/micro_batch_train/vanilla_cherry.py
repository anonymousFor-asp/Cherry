...
from c_block_dataloader import generate_dataloader_block
...
def run(args, device, data):
	...
	for run in range(args.num_runs):
		...
		for epoch in range(args.num_epochs):
			...
			print("TIME RECORD-----------------------------")
			print("Vanilla prepare time: ", vanilla_time)
...
def main():
	...
	argparser.add_argument('--selection-method', type=str, default='vanilla')
	argparser.add_argument('--num-batch', type=int, default=1)
	argparser.add_argument('--batch-size', type=int, default=0)

	argparser.add_argument('--re-partition-method', type=str, default='vanilla')
