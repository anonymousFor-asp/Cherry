...
def save_full_batch(args, epoch,item):
	newpath = r'/home/wangy/Betty/dataset/fan_out_'+args.fan_out+'/'
	if not os.path.exists(newpath):
		os.makedirs(newpath)
	file_name=r'/home/wangy/Betty/dataset/fan_out_'+args.fan_out+'/'+args.dataset+'_'+str(epoch)+'_items.pickle'
	# cwd = os.getcwd() 
